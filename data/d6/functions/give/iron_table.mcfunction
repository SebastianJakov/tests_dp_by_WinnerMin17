...
#5
#give @s minecraft:item_frame{EntityTag:{Invisible:1b,Fixed:1b,Item:{id:"minecraft:barrier",Count:1b}}}
#

# Comandos en el chat de mesa planchera:
#  /item replace entity @e[type=minecraft:item_frame,distance=..1.5] container.0 from entity @s hotbar.0
